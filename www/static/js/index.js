...
var _customScroll = __webpack_require__(27);
...
function InitFullpage() {
  ...
  var $videoSlider = $('.js-fullscreen-slider');
  ...
  if ($fullpage.length) {
    ...
    $playBtn.on('click', function (ev) {
      ...
      $videoSlider.find('.fullscreen__text').addClass(_helpers.css.disabled);
      _helpers.$header.find('.header__contacts').addClass(_helpers.css.disabled);
    });
    ...
    $pauseBtn.on('click', function (ev) {
      ...
      _helpers.$header.find('.header__contacts').removeClass(_helpers.css.disabled);
    });
...
exports.default = customScroll;

__webpack_require__(43);

function customScroll() {
  var $scrollContainer = $('.js-custom-scroll');
...
var require;var require;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* perfect-scrollbar v0.8.0 */
